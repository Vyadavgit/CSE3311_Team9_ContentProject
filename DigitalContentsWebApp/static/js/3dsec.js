function _3dsec(stripe_publishable_key, pi_secret) {
    document.addEventListener("DOMContentLoaded", function(event){
      ...
      /* Following function will display the user an authentication dialog and if authentication fails,
       we will display an error message which is <div id="3ds_result"> in 3dsec.html*/
